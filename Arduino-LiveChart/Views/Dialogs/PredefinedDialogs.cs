...
namespace Arduino_LiveChart.View.Dialogs.Predefined
{
    static class PredefinedDialogs
    {
        public static async Task<object> MessageDialog(object datacontext, string message, DialogOpenedEventHandler doe, DialogClosingEventHandler dce)
        {
        ...
        public static async Task<object> MessageDialog(object datacontext, string message, string buttonText, DialogOpenedEventHandler doe, DialogClosingEventHandler dce)
        {
            var dialog = new MessageDialog
            {
                DataContext = datacontext,
        ...
        public static async Task<object> TwoButtonsDialog(object datacontext, string message, string yesText, string noText, DialogOpenedEventHandler doe, DialogClosingEventHandler dce)
        {
